...
function pageInit() {
	...
	$("#table_list_1").jqGrid({
		...
		styleUI: 'Bootstrap',
		postData: queryObj,
		colNames: ['id', '昵称','昵称en','昵称cht', '个人描述','个人描述En','个人描述Cht', '用户名', '电话', '邮箱', '密码', '是否删除', '状态:是否有效0无效，1有效', 'remark', 'create_time', 'modify_time', 'create_user', 'modify_user', 'register_ip', 'sys_type'],
